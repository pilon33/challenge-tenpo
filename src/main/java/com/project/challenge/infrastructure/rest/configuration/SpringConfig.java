...
import com.project.challenge.infrastructure.limit.LimiterService;
...
public class SpringConfig implements WebMvcConfigurer {
    ...
    @Bean
    @Autowired
    public FilterRegistrationBean<RequestFilter> loggingFilter(ObjectMapper objectMapper, HistoryCommandService historyCommandService, LimiterService limiterService) {
        FilterRegistrationBean<RequestFilter> registrationBean = new FilterRegistrationBean<>();
        registrationBean.setFilter(new RequestFilter(objectMapper(), historyCommandService, limiterService));
